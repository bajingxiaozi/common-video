...
import com.xyf.common.util.ProcessUtils
...
object VideoUtils {
    ...
    fun getVideoInfo(video: File): VideoInfoBean {
        val result = ProcessUtils.execute("ffprobe", "-v", "quiet", "-print_format", "json", "-show_format", "-show_streams", video.absolutePath)
    ...
    fun getFrameCount(video: File): Int {
        ...
        throw IOException("error video info: $video")
    }
